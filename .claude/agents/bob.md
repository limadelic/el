...
- **shipit "message"**: test → commit → push → release → update tap formula (clone limadelic/homebrew-tap, update version/sha256/url/install in Formula/el.rb for tarball, push) → install. The full cycle.
