defmodule El.Platform.Spec do
  ...
  describe "start_link/1" do
    test "passes session_id from options" do
      ...
      El.Platform.start_link(session_id: "test-session-id", session_module: El.MockClaudeCodeSession)
    end
    ...
    test "passes adapter configuration tuple" do
      ...
      El.Platform.start_link(session_module: El.MockClaudeCodeSession)
    end
    ...
    test "passes configured cli_path from options" do
      ...
      El.Platform.start_link(cli_path: "/custom/path", session_module: El.MockClaudeCodeSession)
    end
    ...
    test "start_link/1 passes :resume to session_module when given in opts" do
      ...
      El.Platform.start_link(session_id: "abc", session_module: El.MockClaudeCodeSession, resume: "abc")
    end
    ...
    test "passes :resume to session module from env hook" do
      ...
      El.Platform.start_link(session_id: "session-abc", resume: "session-abc", session_module: El.MockClaudeCodeSession)
    end
  ...
  describe "stream/2" do
    test "delegates to session module" do
      ...
      result = El.Platform.stream(:test_pid, "test prompt", session_module: El.MockClaudeCodeSession)
