...
Mox.defmock(El.MockSessionMeta, for: El.Session.Meta)
Mox.defmock(El.MockSessionAsk, for: El.Session.Behaviours.Ask)
Mox.defmock(El.MockDets, for: El.MessageStore.Behaviours.Dets)
Mox.defmock(El.MockPort, for: El.Infra.Behaviours.Port)
Mox.defmock(El.MockSleeper, for: El.Infra.Behaviours.Sleeper)
Mox.defmock(El.MockNodeConnector, for: El.Infra.Behaviours.NodeConnector)
Mox.defmock(El.MockNetKernel, for: El.Infra.Behaviours.NetKernel)
Mox.defmock(El.MockSessionClaude, for: El.Session.Behaviours.Claude)
Mox.defmock(El.MockSystem, for: El.Infra.Behaviours.System)
Mox.defmock(El.MockGroupLeader, for: El.Infra.Behaviours.GroupLeader)
...
Mox.defmock(El.MockSessionRestorer, for: El.Session.Behaviours.Restorer)
...
Mox.defmock(El.MockEnv, for: El.Infra.Behaviours.Env)
Mox.defmock(El.MockExecutable, for: El.Infra.Behaviours.Executable)
Mox.defmock(El.MockCCParser, for: El.ClaudePort.Behaviours.Parser)
Mox.defmock(El.MockJSONDecoder, for: El.Infra.Behaviours.JSONDecoder)
Mox.defmock(El.MockCardBox, for: El.CLI.Behaviours.CardBox)
Mox.defmock(El.MockTextFormatter, for: El.CLI.Behaviours.TextFormatter)
Mox.defmock(El.MockParser, for: El.ClaudePort.Behaviours.ParserExtract)
Mox.defmock(El.MockParserEventSchema, for: El.ClaudePort.Behaviours.ParserExtract.EventSchema)
Mox.defmock(El.MockParserResult, for: El.ClaudePort.Behaviours.ParserExtract.Result)
Mox.defmock(El.MockClaudePortConnection, for: El.ClaudePort.Behaviours.Connection)
Mox.defmock(El.MockSessionBootstrap, for: El.Session.Behaviours.Bootstrap)
...
Mox.defmock(El.MockSessionRegistry, for: El.Session.Behaviours.Registry)
Mox.defmock(El.MockRPC, for: El.Infra.Behaviours.RPC)
Mox.defmock(El.MockNodeMonitor, for: El.Infra.Behaviours.NodeMonitor)
Mox.defmock(El.MockDaemon, for: El.CLI.Behaviours.Daemon)
Mox.defmock(El.MockDaemonEnv, for: El.CLI.Daemon.Behaviours.Env)
Mox.defmock(El.MockDaemonConnection, for: El.CLI.Daemon.Behaviours.Connection)
Mox.defmock(El.MockPattern, for: El.Behaviours.Pattern)
